...
public class CONSTANTS {
    ...
    public static final String CLIENT_PROXY_CLASS = "com.gurney.wmp.proxy.ClientProxy";
    public static final String COMMON_PROXY_CLASS = "com.gurney.wmp.proxy.CommonProxy";
